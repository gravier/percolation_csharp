 ...
 ****************************************************************************/
    ...
    public class WeightedQuickUnionUF {
        ...
        private int[] _sz;    // sz[i] = number of objects in subtree rooted at i
        ...
        public void union(int p, int q) {
            ...
            if   (_sz[rootP] < _sz[rootQ]) { _id[rootP] = rootQ; _sz[rootQ] += _sz[rootP]; }
            else                         { _id[rootQ] = rootP; _sz[rootP] += _sz[rootQ]; }
            _count--;
        }
